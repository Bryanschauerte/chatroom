...
app.service('parseService', function($http){
  ...
  //Because we're making a POST request, we need a way to tell parse the data we want to give it,
    ...
    //IE data: {text: yourMessage} Also, remember that $http returns a promise. So if you return the
    //whole $http call (return $http(...)), you can then use .then in your controller.
  ...
  //postData method here
    ...
    var data = {
      ...
      return $http({
        //these are the three properties(get dont get data) put and post do
        method: "POST",
